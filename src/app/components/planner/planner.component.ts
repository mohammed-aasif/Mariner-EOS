...
export class PlannerComponent implements OnInit {
  ...
  get formValues() {
      return this.eosAddEventForm.controls;
  }
  get formValuesCustom() {
      return this.eosAddEventFormCustom.controls;
  }
  ...
  onSubmitStandard() {
      ...
      var reqObj = [{}]
      console.log("ooooooooooooo", reqObj)
      ...
      reqObj[0]["startHour"] = new Date(this.eosAddEventForm.value.startHour).toLocaleTimeString([], {
          hour: '2-digit',
          minute: '2-digit'
      });
      reqObj[0]["endHour"] = new Date(this.eosAddEventForm.value.endHour).toLocaleTimeString([], {
          hour: '2-digit',
          minute: '2-digit'
      });
      ...
      reqObj[0]['fkEventFrequencyTypeId'] = {
          id: "1",
          name: "one time"
      }
  ...
  onSubmitCustom(modalContent) {
      ...
      if (this.eosAddEventFormCustom.invalid) {
          ...
          reqObj[0]["startHour"] = new Date(self.eosAddEventFormCustom.value.c_startTime).toLocaleTimeString([], {
              hour: '2-digit',
              minute: '2-digit'
          });
          reqObj[0]["endHour"] = new Date(self.eosAddEventFormCustom.value.c_endTime).toLocaleTimeString([], {
              hour: '2-digit',
              minute: '2-digit'
          });
  ...
  // Edit event (CRUD).....
  onEditEvent(varEdit,datas) {
      console.log("iiiiiiiii", varEdit);
    
      this._serve.onEditlistEvent(datas).subscribe(ssdata => {
        console.log("varEdit ", ssdata);
